...
<h2 class="tw-text-2xl tw-font-semibold tw-text-gray-800 tw-mb-4">Werkende Douglas kortingscodes en aanbiedingen</h2>
...
<td class="tw-px-4 tw-py-3 tw-border tw-border-gray-200">Parfum en cosmetica</td>
...
<td class="tw-px-4 tw-py-3 tw-border tw-border-gray-200">Studenten met geldig bewijs</td>
...
<tr class="tw-bg-white hover:tw-bg-gray-50">
<td class="tw-px-4 tw-py-3 tw-border tw-border-gray-200">MAKEUP10</td>
<td class="tw-px-4 tw-py-3 tw-border tw-border-gray-200 tw-font-bold tw-text-green-700">10% korting</td>
<td class="tw-px-4 tw-py-3 tw-border tw-border-gray-200">Make-up producten</td>
...
`;
export default companyDouglasSeoContent;
